 ...
 */
public class CommunityLifeActivity extends Activity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        swipeLayout.setColorSchemeResources(R.color.holo_purple,
